...
struct filme{ // Cria uma estrutura para setar as variaveis e os tipos das variaveis
    char titulo[30];
    char categoria[10];
    char sinopse[500];
...
struct menu{// Cria a estrutra para facilitar a selecao de filme
    struct filme um;
    struct filme dois;
    struct filme tres;
    struct filme quatro;
...
struct menu menuItens = { // Estrutra com o conteudo dos filmes.
...
int main()
{
    ...
    int opcaoEscolhida;
    // Sistema Logicoe interface para o usuario.
